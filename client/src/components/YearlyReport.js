...
function YearlyReport() {
  ...
  // 🔥 BUILD 365 DAYS
  const build365Days = useCallback((serverData) => {
    let year = [];
    for (let i = 364; i >= 0; i--) {
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Box sx={{ bgcolor: "#F8FAFC", minHeight: "100vh", p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <Box sx={{ textAlign: "center", mb: 6 }}>
          <Typography variant="h3" fontWeight={900}>Yearly Summary</Typography>
        ...
        <Box sx={{ width: '100%', maxWidth: '1000px' }}>
              ...
              <ChartCard>
                <CardContent>
                  <Stack direction="row" spacing={1.5} mb={2}>
                    ...
                    <Typography fontWeight={800}>Yearly Distribution</Typography>
                  </Stack>
              ...
              <ChartCard>
                <CardContent>
                  <Stack direction="row" spacing={1.5} mb={2}>
                    ...
                    <Typography fontWeight={800}>Yearly Trend</Typography>
                  </Stack>
          ...
          <Box sx={{
            ...
            <Typography variant="h6" sx={{ color: '#fff', fontStyle: 'italic' }}>
              "You've built an incredible year of growth. Keep evolving."
            </Typography>
          </Box>
